...
const { translateHeroName, translateMapName } = require('../utils/heroTranslations');
          ...
          if (isSimulationMatch && playerStats.length > 0) {
            ...
            const formatSimulationPlayers = (teamStats) => {
              return teamStats.map(player => ({
                ...
                role: '알 수 없음',
                hero: translateHeroName(player.hero) || '알 수 없음',
          ...
          return {
            ...
            blueTeam: {
              ...
              players: validBlueTeamUsers.map(player => ({
                ...
                hero: translateHeroName(player.stats?.hero) || translateHeroName(player.hero) || '알 수 없음',
